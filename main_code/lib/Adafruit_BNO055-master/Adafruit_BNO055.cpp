...
#ifdef ESP8266
    theWire->setClockStretchLimit(
        1000);  // Allow for 1000us of clock stretching
#endif
...
bool Adafruit_BNO055::begin(adafruit_bno055_opmode_t mode) {
    ...
    */
    ...
    /*
    write8(BNO055_AXIS_MAP_CONFIG_ADDR, REMAP_CONFIG_P2); // P0-P7, Default is
    P1 delay(10); write8(BNO055_AXIS_MAP_SIGN_ADDR, REMAP_SIGN_P2); // P0-P7,
    Default is P1 delay(10);
    */
