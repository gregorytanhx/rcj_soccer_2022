...
class Light {
   public:
    ...
    int fixedThreshBlackBot[32] = {377, 461, 457, 444, 457, 394, 394, 404,
                                   322, 225, 167, 322, 385, 239, 263, 377,
                                   461, 205, 457, 394, 394, 300,  404, 216,
                                   167, 322, 385, 385, 245, 239, 263, 263};
